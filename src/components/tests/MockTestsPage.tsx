...
import { Clock, FileText, Users, Star, Play, CheckCircle2, Filter, Loader2 } from "lucide-react";
...
export function MockTestsPage() {
  ...
  const attempted = tests.filter(t => t.isAttempted).length;
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            ...
            <div className="text-center">
              <div className="text-base font-bold text-gray-900 flex items-center justify-center gap-1">
                ...
                {test.totalAttempts > 1000 ? `${(test.totalAttempts / 1000).toFixed(1)}k` : test.totalAttempts}
              </div>
